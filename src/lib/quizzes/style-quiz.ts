...
export const styleQuiz: QuizConfig = {
  ...
  results: [
    ...
    },
    {
      ...
      visualCards: [
        { label: 'TOP', gradient: 'linear-gradient(145deg, #1A1020 0%, #100818 100%)', tags: ['leather jacket'], query: ['cat_tops', 'style_bohemian', 'cond_vintage'], titleKeywords: ['leather', 'jacket', 'moto'] },
        { label: 'BOTTOM', gradient: 'linear-gradient(145deg, #1E1428 0%, #140E1E 100%)', tags: ['flowy skirt'], query: ['cat_bottoms', 'style_bohemian', 'cond_vintage'], titleKeywords: ['skirt', 'trouser', 'midi'] },
        { label: 'SHOES', gradient: 'linear-gradient(145deg, #1C1020 0%, #120A16 100%)', tags: ['vintage sneakers'], query: ['cat_footwear', 'style_bohemian', 'cond_vintage'], titleKeywords: ['sneaker', 'boot', 'ankle'] },
        { label: 'ACCESSORY', gradient: 'linear-gradient(145deg, #201428 0%, #160E1C 100%)', tags: ['layered chains'], query: ['cat_accessories', 'style_bohemian', 'cond_vintage'], titleKeywords: ['necklace', 'chain', 'earring'] },
      ],
    ...
    },
    {
      ...
      visualCards: [
        ...
        { label: 'BOTTOM', gradient: 'linear-gradient(145deg, #181820 0%, #101018 100%)', tags: ['wide-leg'], query: ['cat_bottoms', 'style_minimalist', 'cond_secondhand'], titleKeywords: ['trouser', 'wide', 'linen', 'corduroy'] },
    ...
    },
    {
      ...
      visualCards: [
        ...
        { label: 'BOTTOM', gradient: 'linear-gradient(145deg, #1A1810 0%, #12100A 100%)', tags: ['tailored'], query: ['cat_bottoms', 'style_luxury', 'cond_secondhand'], titleKeywords: ['trouser', 'wide-leg', 'wool', 'crepe'] },
        ...
        { label: 'ACCESSORY', gradient: 'linear-gradient(145deg, #201C12 0%, #16120C 100%)', tags: ['designer bag'], query: ['cat_accessories', 'style_luxury', 'cond_secondhand'], titleKeywords: ['bag', 'clutch', 'purse', 'tote'] },
      ],
